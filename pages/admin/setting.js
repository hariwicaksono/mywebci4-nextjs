    ...
    API.GetSetting().then((res) => {
      ...
      setTimeout(() =>
        this.setState({
          ...
          landing_intro: data.data.landing_intro,
          landing_link: data.data.landing_link,
          landing_img: data.data.landing_img,
                        ...
                        <Col sm={9}>
                          <Tab.Content>
                            <Tab.Pane eventKey="first">
                              ...
                              >
                                {({ handleSubmit, handleChange, handleBlur, values, setFieldValue, touched, errors, isSubmitting }) => (
                                  <Form noValidate onSubmit={handleSubmit}>
                                    <FloatingLabel controlId="floatingInput" label="Nama Perusahaan *" className="mb-3">
                                      <Form.Control
                                        type="text"
                                        name="company"
                                      ...
                                      <Row>
                                        ...
                                        <div className="form-check form-check-inline">
                                          ...
                                          <label className="form-check-label" htmlFor="inlineRadio3">
                                            <div className="p-3 mb-2 bg-success text-white"></div>
                                          </label>
                                        </div>
                                        ...
                                        <div className="form-check form-check-inline">
                                          ...
                                          <label className="form-check-label" htmlFor="inlineRadio4">
                                            <div className="p-3 mb-2 bg-danger text-white"></div>
                                          </label>
                                        </div>
                                        ...
                                        <div className="form-check form-check-inline">
                                          ...
                                          <label className="form-check-label" htmlFor="inlineRadio5">
                                            <div className="p-3 mb-2 bg-dark text-white"></div>
                                          </label>
                                        </div>
                                      </Row>
                                    </Form.Group>
                                  ...
                                  <Form noValidate onSubmit={handleSubmit}>
                                    ...
                                    <Form.Group className="mb-3">
                                      ...
                                      <Form.Control
                                        ...
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        value={values.landing_link}
                                        isInvalid={!!errors.landing_link && touched.landing_link}
                                      />
                                    ...
                                    <Form.Group className="mb-3">
                                      ...
                                      <Form.Control
                                        ...
                                        onBlur={handleBlur}
                                        isInvalid={!!errors.foto && touched.foto}
                                      />
