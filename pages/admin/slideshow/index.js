  ...
  render() {
    const columns = [
      ...
      ,
      {
        ...
        cell: (row) => (
          <>
            {row.img_slide != null ? (
              <img
                src={this.state.url + row.img_slide}
                width="60"
                alt=""
                onClick={() => {
                  this.dialog.show({
                        ...
                        {({ handleSubmit, handleChange, handleBlur, setFieldValue, values, touched, errors, isSubmitting }) => (
                          <Form onSubmit={handleSubmit}>
                            <Form.Group className="mb-3">
                              <Form.Label>Gambar Slide</Form.Label>
                              <br />
              ...
              <img
                src={`${process.env.BASE_PATH}/images/no-image.png`}
                width="60"
                alt=""
                onClick={() => {
                  this.dialog.show({
      ...
      },
      {
        ...
        cell: (row) => (
          <>
            <Link href={"/admin/slideshow/edit/" + row.id} passHref>
              <Button size="sm" title="Edit" alt="Edit">
                <FaPencilAlt />
              </Button>
            </Link>
            &nbsp;
    ...
    const FilterComponent = ({ filterText, onFilter, onClear }) => (
      <>
        <Link href="/admin/slideshow/create" passHref>
          <Button variant="primary" style={{ position: "absolute", left: "0", marginLeft: "15px" }}>
            Tambah Slideshow
          </Button>
        </Link>
